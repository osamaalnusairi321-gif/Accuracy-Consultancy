...
(function () {
  ...
  const copy = isArabic ? {
    ...
    whatsapp: 'واتساب',
    location: 'متاح في الولايات المتحدة والمملكة العربية السعودية واليمن',    footerBlurb: 'استشارات وأبحاث وحلول مدعومة بالذكاء الاصطناعي للمؤسسات التي تتعامل مع أسواق وبرامج وعمليات معقدة.',
    ...
    whatsapp: 'WhatsApp',
    location: 'Available in the United States, Saudi Arabia & Yemen',    footerBlurb: 'Advisory, research, and AI-enabled solutions for organisations navigating complex markets, programmes, and operations.',
